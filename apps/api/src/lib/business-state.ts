...
export function emptyBusinessState() {
  ...
  return {
    ...
    motifsSortieAtelier: [] as unknown[],
    sortiesAtelier: [] as unknown[],
    comptesTresorerie: [] as unknown[],
    lignesReleveBancaire: [] as unknown[],
    modesPaiement: [] as unknown[],
    ...
    entrees: [] as unknown[],
    achats: [] as unknown[],
    lotsPaiementFournisseur: [] as unknown[],
    transfertsStock: [] as unknown[],
    transfertsMatiereOf: [] as unknown[],
    ordresFabrication: [] as unknown[],
    bonsATirer: [] as unknown[],
    missionsAchat: [] as unknown[],
    comptesMissionAcheteur: [] as unknown[],
    demandesPrix: [] as unknown[],
    besoinsAchat: [] as unknown[],
    ventes: [],
    relancesImpayes: [] as unknown[],
